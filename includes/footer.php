            ...
            <div class="grid grid-cols-1 gap-10 md:grid-cols-4">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-3">
                        <!-- GitHub (Reactivated!) -->
                        <a href="https://github.com/rana2742/sbgbzu" target="_blank" rel="noopener noreferrer" class="flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 text-slate-700 dark:text-white hover:bg-purple-600 hover:text-white dark:hover:bg-purple-600 hover:-translate-y-1 transition-all duration-300" title="GitHub Repository">

            ...
            <div class="grid grid-cols-1 gap-10 md:grid-cols-4">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-3">
                        <!-- GitHub -->
                        <a href="https://github.com/MuzammilShadab1122/sbgbzu" target="_blank" rel="noopener noreferrer" class="flex h-10 w-10 items-center justify-center rounded-full bg-slate-200/90 dark:bg-white/10 border border-slate-300 dark:border-white/20 text-slate-800 dark:text-slate-100 hover:bg-purple-600 hover:text-white dark:hover:bg-purple-600 hover:-translate-y-1 transition-all duration-300 shadow-sm" title="GitHub Repository">
                        ...
                        <!-- LinkedIn -->
                        <a href="https://www.linkedin.com/company/aws-cloud-club-bzu-multan/" target="_blank" rel="noopener noreferrer" class="flex h-10 w-10 items-center justify-center rounded-full bg-slate-200/90 dark:bg-white/10 border border-slate-300 dark:border-white/20 text-slate-800 dark:text-slate-100 hover:bg-[#0A66C2] hover:text-white dark:hover:bg-[#0A66C2] hover:-translate-y-1 transition-all duration-300 shadow-sm" title="LinkedIn">
                        ...
                        <!-- Instagram -->
                        <a href="https://www.instagram.com/aws_sbg_bzu" target="_blank" rel="noopener noreferrer" class="flex h-10 w-10 items-center justify-center rounded-full bg-slate-200/90 dark:bg-white/10 border border-slate-300 dark:border-white/20 text-slate-800 dark:text-slate-100 hover:bg-pink-500 hover:text-white dark:hover:bg-pink-500 hover:-translate-y-1 transition-all duration-300 shadow-sm" title="Instagram">
                        ...
                        <!-- Meetup -->
                        <a href="https://www.meetup.com/aws-sbg-at-bahauddinzakariya-univ-multan" target="_blank" rel="noopener noreferrer" class="flex h-10 w-10 items-center justify-center rounded-full bg-slate-200/90 dark:bg-white/10 border border-slate-300 dark:border-white/20 text-slate-800 dark:text-slate-100 hover:bg-[#E51937] hover:text-white dark:hover:bg-[#E51937] hover:-translate-y-1 transition-all duration-300 shadow-sm" title="Meetup">
